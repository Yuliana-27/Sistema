...
<!--este es la parte de boostrap y php del registo y modificar-->
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $dato->num_control; ?></td>

                                <td style="color: 
    <?php 
        if ($dato->carrera === 'Sistemas') {
            echo 'red'; // Color para la carrera "Sistemas"
        } elseif ($dato->carrera === 'Informatica') {
            echo 'green'; // Color para otra carrera
        } else {
            echo 'blue'; // Color por defecto
        } 
    ?>
">
    <?php echo $dato->carrera; ?>
</td>
            ...
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrar.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="txtNum_control" autofocus required>
                    </div>
                    <div class="mb-3">
